...
namespace GPUInstancer
{
    public static class GPUInstancerUtility
    {
        ...
        private static string ReplaceShaderTextHLSLProgram(string includePath, string newShaderText, bool doubleEscape)
        {
            ...
            string additionTextStart = GPUInstancerConstants.gpuiSettings.isHDRP ? "\n#include \"Packages/com.unity.render-pipelines.core/ShaderLibrary/Common.hlsl\"\n#include \"Packages/com.unity.render-pipelines.high-definition/Runtime/ShaderLibrary/ShaderVariables.hlsl\"\n\n#include \"" + includePath + "\"\n#pragma instancing_options procedural:setupGPUI\n#pragma multi_compile_instancing\n" : "";
            if (doubleEscape)
                additionTextStart = additionTextStart.Replace("\n", "\\n").Replace("\"", "\\\"");
            string searchEnd = "ENDHLSL";
            string additionTextEnd = GPUInstancerConstants.gpuiSettings.isHDRP ? "" : "\n#include \"" + includePath + "\"\n#pragma instancing_options procedural:setupGPUI\n#pragma multi_compile_instancing\n";
            if (doubleEscape)
            ...
            #region Temp Unity 2021.2.8 Bug Fix
#if UNITY_2021_2_8
            if (!GPUInstancerConstants.gpuiSettings.IsStandardRenderPipeline())
