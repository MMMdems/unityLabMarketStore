...
namespace GPUInstancer
{
    ...
    {
        public static readonly string GPUI_VERSION = "GPU Instancer v1.7.1";
        public static readonly float GPUI_VERSION_NO = 1.71f;
        ...
        [MenuItem("Tools/GPU Instancer/Help/Unity 2021.2.8 Shader Bug Fix", validate = false, priority = 991)]
        public static void ModifyGeneratedShaders()
        {
            if (EditorUtility.DisplayDialog("Temp Unity 2021.2.8 Bug Fix", "This operation will modify GPUI auto generated shaders to compansate for the Unity 2021.2.8 Shader Bug.\n\nDo you wish to continue?",
                       "Yes", "No"))
            {
